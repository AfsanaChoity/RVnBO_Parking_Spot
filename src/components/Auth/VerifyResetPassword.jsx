...
import { useVerifyResetPasswordMutation, useResendResetCodeMutation } from "../../redux/api/authApi";
...
export default function VerifyResetPassword() {
    ...
    const handleVerify = async () => {
        ...
        try {
            ...
            const response = await verifyResetPassword({ code: codeString }).unwrap();
