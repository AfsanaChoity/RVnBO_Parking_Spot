...
import { useCreateSpotMutation } from "../../../redux/api/landownerApi";

export default function AddSpot({ isOpen, onClose }) {
    ...
    const [createSpot, { isLoading, error }] = useCreateSpotMutation();
    ...
    const handleSubmit = async (e) => {
        ...
        const spotData = {
            ...
            image: base64Images, // Send Base64 array
        ...
        try {
            ...
            toast.error(err?.data?.message || "Error creating spot");
        }
    };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative mx-4 md:mx-0 bg-[#fff] border border-gray-200 rounded-lg shadow-xl max-w-xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between px-6 pb-0 pt-8">
                    <h2 className="text-xl font-semibold text-gray-900">Add Your Spot</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            {/* <label className="block text-base font-semibold text-gray-800 mb-2">Latitude</label> */}
                            <input
                                type="number"
                                step="any"
                        ...
                        <div>
                            {/* <label className="block text-base font-semibold text-gray-800 mb-2">Longitude</label> */}
                            <input
                                type="number"
                                step="any"
                    ...
                    <div>
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-3 text-center hover:border-gray-400 transition-colors">
                            ...
                            <label htmlFor="photo-upload" className="cursor-pointer flex flex-col items-center">
                                ...
                                <span className="text-sm text-gray-700 font-medium">Upload photos</span>
                    ...
                    <div>
                        <label className="flex items-start text-base font-semibold text-gray-800">
                            ...
                            <span className="ml-2 text-sm text-gray-800">
                                I agree to the <a className="text-teal-600 underline">Terms &amp; Conditions</a>
                            </span>
                        </label>
                    </div>
