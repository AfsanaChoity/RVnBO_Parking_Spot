  ...
  return (
    <Box>
      ...
      <Stack direction="row" spacing={1} sx={{ mt: 2, mb: 6 }}>
        <Button size="small" variant="outlined" sx={{ color: 'teal', borderColor: 'teal', '&:hover': { borderColor: 'teal', backgroundColor: 'rgba(0,255,255,0.1)' } }}  onClick={onClear}>Clear</Button>
