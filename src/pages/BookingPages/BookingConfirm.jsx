  ...
  return (
    <div className='container mx-auto pt-20 px-4'>
        ...
        <div className='flex flex-col items-center space-y-14'>
            ...
            <p className='text-[22px] md:text-[32px] text-gray-600 mb-10'>Thanks for choosing RVnBo. Your next adventure is ready</p>
        </div>
        ...
        <div className='flex flex-col md:flex-row gap-4 my-10 justify-center'>
            ...
            <Link to="/">
             <TealButton text="Back To Home"></TealButton>
            </Link>
        </div>
