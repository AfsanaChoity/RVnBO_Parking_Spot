...
export const ChatLayout = () => {
  ...
  return (
    <div className="h-screen flex bg-gray-100">
      <div className={`${showSidebar ? "block" : "hidden"} md:block md:w-80 w-full`}>
        <ChatSidebar selectedUserId={selectedUser?._id} onUserSelect={handleUserSelect} users={users} />
      </div>
        ...
        {selectedUser ? (
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 h-screen overflow-y-auto">
              <ChatWindow selectedUser={selectedUser} socket={socket} handleBackToSidebar={handleBackToSidebar} />
            </div>
          </div>
        ) : (
          <div className="flex-1 flex items-center justify-center">
